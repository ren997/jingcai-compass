...
class AdminDraftPredictionControllerSecurityTest {
    ...
    @Test
    void draftPathRequiresAdministratorJwt() throws Exception {
    ...
    @Test
    void administratorCanReadDraftPath() throws Exception {
