...
| M5 公共 API 与前端 | `PARTIAL` | T501、T502、T503、T506、T507 已完成；下一任务为 T504 历史与统计前后端 |
...
当前无活动任务；T401 已完成赛果事实与结算持久化基线及 PostgreSQL 16 CI 验证，T402 已完成 Stub 驱动的赛果同步，T403 已完成纯函数市场结算规则，T404 已完成自动结算闭环，T405 已完成赛果修正后的版本化结算重算，T501 已完成公共持久化比赛查询，T506 已完成公开预测详情前后端增量，T507 已完成公开历史与统计 API，M4 已完成。

下一主线任务为 `T504 历史与统计前后端`；基于 T507 的历史/统计 API 建立 URL 可恢复的筛选、分页、指标和窄屏页面。
...
已完成：T501 公共比赛查询 API、T502 前端路由、请求和布局、T503 比赛列表与基础详情前后端、T506 公开预测详情前后端增量
下一步：T504 历史与统计前后端
```
