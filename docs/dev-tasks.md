...
- 当前活动任务：`T506 公开预测详情前后端增量`
- 下一任务：`T506 公开预测详情前后端增量（进行中）`
- 最近完成增量：`T503 比赛列表与基础详情前后端`
...
| M5 公共 API 与前端 | `PARTIAL` | T501、T502、T503、T507 已完成；下一任务为 T506 公开预测详情前后端增量 |
...
下一主线任务为 `T506 公开预测详情前后端增量`；在已完成的比赛详情基础上，增加当前公开预测、模型透明信息和快照入口。
...
已完成：T501 公共比赛查询 API、T502 前端路由、请求和布局、T503 比赛列表与基础详情前后端
下一步：T506 公开预测详情前后端增量
```
